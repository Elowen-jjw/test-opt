...
public class GenAndTestUnrolling {
    File sourceDir;

    String unrollingPath;

    GenAndTestUnrolling(File sourceDir, String muIndexPath){
    ...
    public void genAndTestMutation() {
        ...
        for(File file: allFileList) {
            ...
            //Test Mutations
            DirIterator dt = new DirIterator(new File(unrollingPath));
            dt.runSingleRandom(new File(unrollingPath + "/" + file.getName().substring(0, file.getName().lastIndexOf(".c"))));
        }
